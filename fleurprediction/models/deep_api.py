...
import fleurprediction.config as cfg
...
def _predict_data(*args):
    ...
    #Step 3 : Exportation
    image_output = []
    for sample,i,name in zip(image_prediction,range(len(size_original)),image_list):
...
def _predict_url(*args):
    """
    Function to perform segmentation of flowering apple tree picture
    """
